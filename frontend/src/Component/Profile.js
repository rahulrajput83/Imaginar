...
import { FaChevronLeft, FaGlobeAsia, FaRegCalendar, FaTrash } from 'react-icons/fa'
                            ...
                            data.map((data, index) => {
                                return (
                                    <div key={index} className='w-full relative'>
                                        ...
                                        <FaTrash onClick={() => deleteOpen(data._id)} className='cursor-pointer text-slate-800 hover:text-slate-500 absolute top-10 right-6' />
                                    </div>
                                )
                            })
                        }
